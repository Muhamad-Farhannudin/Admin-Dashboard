...
import Zoom from '../assets/images/Aplikasi Seminar/zoom.png'
import Meet from '../assets/images/Aplikasi Seminar/meet.png'
import WhatsApp from '../assets/images/Aplikasi Seminar/whatsApp.png'
import { Link } from "react-router-dom";

export default function AplikasiSeminar() {
    ...
    return (
        ...
        <div className="flex font-Mulish bg-white">
            ...
            <div className="flex justify-between px-[30px] my-[30px] items-center w-full h-[44px]  text-primary">
                <h1 className="text-2xl font-bold leading-[30px]">Aplikasi Seminar</h1>
            ...
            <div className="w-full px-8">
                ...
                <div className="w-1/2 flex justify-between items-center mx-auto">
                    <img className="w-[96px] h-[96px]" src={WhatsApp} alt="zoom" />
                    <img className="w-[96px] h-[96px]" src={Meet} alt="meet" />
                    <img className="w-[96px] h-[96px]" src={Zoom} alt="zoom" />
                </div>
                ...
                <div className="w-1/2 mx-auto flex flex-col pt-7">
                    <label className="font-inter mb-2 text-sm font-normal text-[#828282]">Jam</label>
                    <input type="text" placeholder="Jam" className="bg-[#F2F2F2]/40 border-input rounded-lg p-3" />
                </div>
                <div className="w-1/2 mx-auto flex flex-col pt-10">
                    <label className="font-inter mb-2 text-sm font-normal text-[#828282]">Link Seminar</label>
                    <input type="text" placeholder="Link Seminar" className="bg-[#F2F2F2]/40 border-input rounded-lg p-3" />
                </div>
                </div>
